...
echo -e "${BLUE}🚀 Publishing n8n v${N8N_VERSION} to Docker Hub${NC}"
echo ""
...
docker buildx build \
  ...
  --tag ${IMAGE_NAME}:${N8N_VERSION} \
  --tag ${IMAGE_NAME}:${N8N_VERSION}-debian \
...
if docker pushrm ${IMAGE_NAME} -f ${CURRENT_DIR}/README.md --short "Production-ready n8n - Powerful workflow automation tool for technical teams"; then
...
echo "  • ${IMAGE_NAME}:${N8N_VERSION}-debian"
echo "  • ${IMAGE_NAME}:latest"
echo "  • ${IMAGE_NAME}:latest-debian"
echo ""
echo -e "${BLUE}View at: https://hub.docker.com/r/zylarian/dockyard-n8n${NC}"
echo ""
