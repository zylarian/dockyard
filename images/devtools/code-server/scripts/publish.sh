#!/bin/bash
# Publish script for Code Server
...
echo -e "${BLUE}🚀 Publishing Code Server v${CODE_SERVER_VERSION} to Docker Hub${NC}"
echo ""
...
if docker pushrm ${IMAGE_NAME} -f ${CURRENT_DIR}/README.md --short "Production-ready Code Server - VS Code in the browser"; then
...
echo ""
echo -e "${BLUE}View at: https://hub.docker.com/r/zylarian/dockyard-code-server${NC}"
echo ""
