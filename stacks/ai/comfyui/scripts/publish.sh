...
echo -e "${BLUE}🚀 Publishing ComfyUI to Docker Hub${NC}"
echo ""
...
if docker pushrm ${IMAGE_NAME} -f ${CURRENT_DIR}/README.md --short "ComfyUI - Powerful node-based UI for Stable Diffusion workflows"; then
...
echo ""
echo "Published tags (platform: ${PLATFORMS}):"
echo ""
echo -e "${BLUE}Debian:${NC}"
echo "  • ${IMAGE_NAME}:latest"
echo "  • ${IMAGE_NAME}:latest-debian"
echo ""
echo -e "${BLUE}View at: https://hub.docker.com/r/zylarian/dockyard-comfyui${NC}"
